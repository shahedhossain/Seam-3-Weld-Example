 ...
 This will deploy two artifacts, target/seam3-weld.war and
 default-ds.xml.
 ...
 - http://localhost:8080/seam3-weld/
 ...
 Now you can either deploy the target/seam3-weld.war through the
 web-based GlassFish admininstration console, or you can again use asadmin:

  ./asadmin deploy target/seam3-weld.war

 To undeploy the application, run:

  ./asadmin undeploy seam3-weld
